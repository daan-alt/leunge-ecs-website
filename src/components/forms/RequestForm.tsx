...
import type { RequestFormContent } from "@/content/types";
            ...
            {status === "success" ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-8" noValidate>
                ...
                <div>
                  ...
                  <p className="mt-1 font-body text-xs text-ink/70">{content.form.fileHint}</p>
                  <input
                    id="attachment"
                    name="attachment"
                    type="file"
                    ...
                    className="mt-3 block w-full border border-dashed border-line px-4 py-3 font-body text-sm text-ink file:mr-4 file:border-0 file:bg-navy file:px-4 file:py-2 file:font-body file:text-xs file:font-bold file:uppercase file:tracking-wide file:text-white hover:file:bg-accent"
                  />
                  {fileNames.length > 0 && (
